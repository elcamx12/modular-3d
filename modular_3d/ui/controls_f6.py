...
class F6Mixin:
    ...
    def _run_structural_analysis(self):
        ...
        dprint('ANALYSIS', '[ANALYSIS] F6 → OpenSees 5 케이스 자동 해석 시작')
        try:
    ...
    def _run_quantity_takeoff_for_case(self, am, all_results, case_name: str):
        ...
        - 'ENVELOPE' : 5 케이스 모든 단면력의 절댓값 최대(envelope) 로 demand.
        - 그 외 : 해당 단일 케이스 단면력으로 demand.
    ...
    def _on_panel_case_changed(self, case_name: str):
        ...
        (2026-05-19 작업 5) 'ENVELOPE' = 지배조합 = 5 케이스 envelope demand.
