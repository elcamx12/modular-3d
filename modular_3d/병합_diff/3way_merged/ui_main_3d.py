...
class MainWindow(QMainWindow):
    ...
    def _build_design_tab(self) -> QWidget:
        ...
        # [2026-06-02] 벽 채움면 / 실 표기 표시 토글 (체크박스 2개).
...
if __name__ == '__main__':
    main()
||||||| modular_3d/병합_diff/3way_base/ui_main_3d.py
"""
진입점 — QMainWindow + QTabWidget(7 탭) + Vispy + Controller 연결.
실행: venv/Scripts/python.exe -m modular_3d
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        # [2026-06-01] 한국어 폰트(Freesentation 본문 / Paperlogy 헤드라인) 등록.
        try:
    ...
    def _build_design_tab(self) -> QWidget:
        ...
        # [2026-05-30 B3] 3D 뷰 바로 아래 z축 단면(수평 평면 절단) 슬라이더.
        self._design_left_lay.addWidget(self._build_section_slider())
        # [2026-06-01] Y축 단면 슬라이더 — Z축과 같은 패턴, normal (0,-1,0)
...
if __name__ == '__main__':
    main()
>>>>>>> /c/Users/이건영/AppData/Local/Temp/claude/tmp.KQ87dJvaXl
