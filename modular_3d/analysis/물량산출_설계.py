...
- 강재 재질  : SS275 (Fy = 275 MPa, KBC 표준)
- 설계 기준  : KBC 2022 LRFD (한국 한계상태설계법)
...
- 부분안전계수: φb = 0.9 (휨), φc = 0.9 (압축), φv = 0.9 (전단) — KBC LRFD
...
- 함수 aggregate_slabs(scene) → SlabQuantity
  ...
  · 알고리즘:
    ...
    · 부피 = 면적 × 두께
    · 철근 비율 = 0.012 (1.2 vol%, KBC 표준 슬래브 평균 가정)
